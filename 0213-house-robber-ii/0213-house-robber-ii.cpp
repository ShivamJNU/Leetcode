...
public:
    ...
    int func(vector<int>&nums, int index, bool flag){
        ...
        int ans1,ans2;
            ...
            ans1=func(nums, index-1, flag);
            ans2=func(nums, index-2, flag)+nums[index];
    ...
    int rob(vector<int>& nums) {
        ...
        int ans1=func(nums, nums.size()-2, false);
        
        memset(DP, -1, sizeof(DP));
        int ans2=func(nums, nums.size()-3, true)+nums[nums.size()-1];
